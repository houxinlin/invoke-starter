...
import com.cool.request.components.spring.controller.SpringRequestMappingComponent;
...
public class MockClassLoader extends URLClassLoader {
    ...
    protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
        try {
            if (name.equals("com.cool.request.components.spring.controller.Dispatcher")) {
