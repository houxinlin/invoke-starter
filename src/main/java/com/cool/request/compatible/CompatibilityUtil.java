package com.cool.request.compatible;
...
public class CompatibilityUtil {
    ...
    public static void invokeHandlerAdapter_handle(HandlerAdapter instance, Object request, Object response, Object handler) {
        try {
            ...
            handle.bindTo(instance).invokeWithArguments(request, response, handler);
        } catch (Throwable e) {
            throw new RuntimeException(e);
        }
    }
